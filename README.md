...
|------------|---------|---------|
| **Next.js** | 14.2.35 | React framework with SSR/SSG support |
...
|-------|------|-------------|
| `/` | Home | Automatically redirects to `/portraits` |
| `/portraits` | Portraits | Gallery showcasing portrait photography |
| `/real-estate` | Real Estate | Property and architecture photos |
| `/events-and-weddings` | Events & Weddings | Wedding and event photography |
| `/about` | About | Photographer's story and philosophy |
| `/book-now` | Book Now | Contact and booking information |
...
2. Update the corresponding JSON files in the content folders:
